...
--ALIASING -> renomeia uma coluna mas apenas para a vizualização sem mudar o nome original no BD
--COUNT -> faz contagem do número de registros
...
--LIKE -> toda e qualquer descrição
AND DescricaoProduto LIKE '%Notebook%' OR PrecoProduto > 4000 

--uso do not -> não envolver determinado vendedor
